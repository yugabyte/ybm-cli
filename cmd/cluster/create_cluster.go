...
func init() {
	...
	createClusterCmd.Flags().String("preferred-region", "", "[OPTIONAL] The preferred region in a multi-region cluster")
	createClusterCmd.Flags().String("default-region", "", "[OPTIONAL] The default region in a geo partitioned cluster")
