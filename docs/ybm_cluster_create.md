...
```
      ...
      --preferred-region string        [OPTIONAL] The preferred region in a multi-region cluster
      --default-region string          [OPTIONAL] The default region in a geo partitioned cluster
