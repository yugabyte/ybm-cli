...
Trigger resync of backup data for a cluster. Resyncs all backup replication configs and creates one-time transfer operations for existing transfer jobs to synchronize data to GCS buckets.
